...
public interface DANSGrammarListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterPowerExpression(@NotNull DANSGrammarParser.PowerExpressionContext ctx);
	/**
	 * Exit a parse tree produced by the {@code powerExpression}
	 * labeled alternative in {@link DANSGrammarParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitPowerExpression(@NotNull DANSGrammarParser.PowerExpressionContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterInExpression(@NotNull DANSGrammarParser.InExpressionContext ctx);
	/**
	 * Exit a parse tree produced by the {@code inExpression}
	 * labeled alternative in {@link DANSGrammarParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitInExpression(@NotNull DANSGrammarParser.InExpressionContext ctx);
	/**
